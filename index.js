...
async function loadMainPrompts() {
  ...
  switch (choice) {
    ...
    case "ADD_ROLE":
      return addRole();
    case "VIEW_DPARTMENTS":
      return viewDepartments();
    case "ADD_DPARTMENT":
      return addDepartment();
    case "REMOVE_DPARTMENTS":
  ...
  const {managerId} = await prompt([
    {
      type: "list",
      name: "managerId",
      message: "which employee direct report would you like to see?",
...
async function addDepartment(){
  ...
  await db.creatDepartment(Department);
